  ...
  let data = [
    {
      ...
      videoUri: v1,
      title:
        "Before you sleep, this is the meditation video to help you get sleep",
    },
    {
      id: 2,
      tumbnail: img2,
    ...
    },
    {
      ...
      videoUri: v3,
      title:
        "Oddly Satisfying & ASMR Video That Relaxes You Before Sleep | All Original Satisfying Videos",
    },
  ];

  return (
    <div className="flexing-div">   
        <div className="videos-allpage">
            <p className="title-head">Videos might help you</p>
        ...
        <div className="videos-allpage2">
            <p className="title-head">Watch this before you sleep</p>
            <div className="videos-div">
                {data.map((item, index) => {
                    let divRef = createRef(null);
                    return (
